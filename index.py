...
def f_about():
    ...
    print('|', ' '*112, '|')
    print('|    Developed by:-', ' '*94, '|')
    print('|', ' '*112, '|')
    print('|', ' '*12, 'Varun Baisane     Class: XII    Roll No: 20', ' '*55, '|')
    print('|', ' '*12, 'Anant Jaiswara    Class: XII    Roll No: 05', ' '*55, '|')
    print('|', ' '*12, 'Sarthak Dale      Class: XII    Roll No: 15', ' '*55, '|')
    print('|', ' '*112, '|')
    print('|', ' '*112, '|')
    print('|',' '*27, '© Copyright 2022 | JC Registralᵀᴹ | All Rights Reserved.',' '*27, '|')
    print('+'+ '-'*114 +'+')
    time.sleep(1)
    f_panel()
